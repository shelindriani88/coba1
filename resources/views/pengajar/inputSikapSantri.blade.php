          ...
          <div class="card">
            <div class="card-body">
              @if(\Session::has('alert'))
                ...
                @endif
                @inject('sikap', 'App\nilaiSikap')
                <form class="" action="/inputSikap" method="post">
                  @csrf
                            <div class="md-form">
                                <select class="mdb-select md-form" name="id_santri" searchable="Pilih Santri">
                                  <option value="" disabled selected>Pilih Santri</option>

                                  @foreach ($dataSantri as $santri)
                                    @php
                                    $selectSikap = $sikap::where('id_santri','=',$santri->id_santri)->first();
                                    @endphp
                                    @php
                                      if (!empty($selectSikap->id_santri)) {
                                        continue;
                                      }
                                    @endphp
                            ...
                            <div class="md-form">
                                <select class="mdb-select md-form" name="sikap" searchable="Pilih Sikap">
                            ...
                            <div class="text-center">
                              <button class="btn btn-indigo btn-rounded mt-5">Tambah Sikap Santri</button>
                            </div>
                          </form>
                        </div>
                        </div>
