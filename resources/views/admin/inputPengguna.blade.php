    ...
    <body class="fixed-sn grey-skin">
      ...
      <div class="card">
        <div class="card-body">
                        ...
                        <div class="">
                          <a type="button" class="btn btn-indigo btn-rounded mt-5" href="{{ url('/inputGuru') }}">Tambah Guru</a>
                        </div>

                        <div class="">
                          <a type="button" class="btn btn-indigo btn-rounded mt-5" href="{{ url('/inputOrtu') }}">Tambah OrangTua</a>
                        </div>
