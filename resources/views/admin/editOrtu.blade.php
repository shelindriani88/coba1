                  ...
                  @csrf
                          <div class="col col-lg-100">
                            ...
                            <div class="md-form">
                              ...
                              <input type="text" id="nama_orangtua" name="nama_orangtua" value="{{$editOrtu->nama_orangtua}}" class="form-control">
                            ...
                            <div class="md-form">
                              <i class="fa fa-user prefix"></i>
                              <input type="number" id="noHp" name="noHp" value="{{$editOrtu->noHp}}" class="form-control">
                              <label for="noHp">Nomer Handphone OrangTua</label>
                            </div>
                            <div class="form-group purple-border">
                              <i class="fas fa-road prefix"></i>
                              <label for="alamat">Alamat Lengkap</label>
                              <textarea class="form-control" id="alamat" name="alamat" rows="3">{{$editOrtu->alamat}}</textarea>
                            </div>

                            <div class="text-center">
                              <button class="btn btn-indigo btn-rounded mt-5">Edit OrangTua</button>
                            </div>
                          </form>
                          </div>
                        </div>
