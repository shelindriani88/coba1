    ...
    <body class="fixed-sn grey-skin">
          ...
          <div class="card">
            ...
            <div class="mask rgba-gradient">
              <div class="container">
                <form class="" action="inputSantri" method="post" enctype="multipart/form-data">
                  @csrf
                          <div class="col col-lg-100">
                            <div class="md-form">
                              <input type="text" id="nama_santri" name="nama_santri" class="form-control">
                              <label for="nama_guru">Nama Santri</label>
                            </div>
                            <div class="md-form">
                                <select class="mdb-select md-form" name="id_ortu" searchable="Pilih Orang Tua">
                                  <option value="" disabled selected>Pilih Data Orang Tua</option>
                                  @foreach ($dataOrtu as $ortu)
                                  <option value="{{$ortu->id_ortu}}">{{$ortu->nama_orangtua}}</option>
                                  @endforeach
                                </select>

                            </div>
                            <div class="md-form">
                                <select class="mdb-select md-form" name="id_kelas" searchable="Pilih Orang Tua">
                                  <option value="" disabled selected>Pilih Data Kelas</option>
                            ...
                            <div class="md-form">
                                <select class="mdb-select md-form" name="id_kelompok" searchable="Pilih Kelompok Hafalan">
                                  <option value="" disabled selected>Pilih Data Kelompok Hafalan</option>
                            ...
                            <div class="text-center">
                              <button class="btn btn-indigo btn-rounded mt-5">Tambah Santri</button>
                            </div>
                          </form>
                          </div>
                        </div>
