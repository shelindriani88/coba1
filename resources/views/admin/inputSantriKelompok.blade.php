    ...
    <header>
        ...
        <nav class="navbar fixed-top navbar-expand-lg scrolling-navbar double-nav">
            ...
            <div class="breadcrumb-dn mr-auto">
                <p>Tambah Santri Kelompok ({{$kelompok->nama_kelompok}})</p>
            </div>
            ...
            <div class="card-body">
              @if(\Session::has('alert'))
                ...
                @if(\Session::has('alert-success'))
                    ...
                    <script>
                      setTimeout(function() {
                        window.location = 'dataSantriKelompok/{{$id_kelompok}}'
                      }, 1500);
                    </script>
                @endif
            <div class="mask rgba-gradient">
              <div class="container">
                <form class="" action="inputSantriKelompok/{{$id_kelompok}}" method="post">
                  @csrf
                          <div class="col col-lg-100">
                              <div class="md-form">
                                  <select class="mdb-select md-form" name="id_santri[]" searchable="Pilih Santri" multiple="multiple">
                                    <option value="" disabled selected>Choose your option</option>

                                    @foreach ($dataSantri as $santri)
                                      @php
                                        if (!empty($santri->id_kelompok)) {
                                          continue;
                                        }
                                      @endphp
                            ...
                            <div class="text-center">
                              <button class="btn btn-indigo btn-rounded mt-5">Tambah Santri Kelompok</button>
                            </div>
