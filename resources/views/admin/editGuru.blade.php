                  ...
                  @csrf
                          <div class="col col-lg-100">
                            ...
                            <div class="md-form">
                              ...
                              <input type="text" id="nama_guru" name="nama_guru" value="{{$editGuru->nama_guru}}" class="form-control">
                              <label for="nama_guru">Nama Ustadz/Guru</label>
                            </div><div class="md-form">
                              <input type="text" id="tempat_lahir" name="tempat_lahir" value="{{$editGuru->tempat_lahir}}" class="form-control">
                              <label for="tempat_lahir">Tempat Lahir</label>
                            </div>
                            <div class="md-form">
                              <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="{{$editGuru->tanggal_lahir}}" class="form-control">
                            ...
                            <div class="form-group purple-border">
                              ...
                              <textarea class="form-control" id="alamat" name="alamat" rows="3">{{$editGuru->alamat}}</textarea>
                            </div>
                            <div class="md-form">
                              <i class="fa fa-user prefix"></i>
                              <input type="number" id="noHp" name="noHp" value="{{$editGuru->noHp}}" class="form-control">
                              <label for="noHp">Nomer Handphone Ustadz/Guru</label>
                            </div>
                            <div class="text-center">
                              <button class="btn btn-indigo btn-rounded mt-5">Edit Ustadz/Guru</button>
                            </div>
                          </form>
                          </div>
                        </div>
